...
Below we assign the values of the variable \texttt{ft\_hclinton} to a new variable called \texttt{hillary\_therm}. The dataset is named ``nes''.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nes}\SpecialCharTok{$}\NormalTok{hillary\_therm }\OtherTok{\textless{}{-}}\NormalTok{ nes}\SpecialCharTok{$}\NormalTok{ft\_hclinton}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nes }\OtherTok{\textless{}{-}}\NormalTok{ nes }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{hillary\_therm =}\NormalTok{ ft\_hclinton)}
\end{Highlighting}
\end{Shaded}
...
Below we create a variable \texttt{avg\_demfeel} that is the average feeling thermometer of \texttt{obama\_therm}, \texttt{ft\_dem}, and \texttt{ft\_hclinton}.
...
\NormalTok{nes }\OtherTok{\textless{}{-}}\NormalTok{ nes }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{avg\_demfeel =}\NormalTok{ (obama\_therm }\SpecialCharTok{+}\NormalTok{ ft\_dem }\SpecialCharTok{+}\NormalTok{ ft\_hclinton)}\SpecialCharTok{/}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-44-1.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-44-2.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-46-1.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-46-2.pdf}
...
\begin{Highlighting}[]
\CommentTok{\# the frequency table for the old variable}
\FunctionTok{freq}\NormalTok{(nes}\SpecialCharTok{$}\NormalTok{abort4)}
\end{Highlighting}
\end{Shaded}

\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-48-2.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-50-1.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-50-2.pdf}
...
\hypertarget{solution---tidyverse-1}{%
\subsection{Solution - Tidyverse}\label{solution---tidyverse-1}}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-52-1.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-52-2.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-56-1.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-58-1.pdf}
...
\includegraphics{psc-253-manual_files/figure-latex/unnamed-chunk-60-1.pdf}
